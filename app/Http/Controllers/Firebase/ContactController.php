...
class ContactController extends Controller
{
    ...
    public function index(){
        ...
        return view('firebase.contact.index', compact('contacts', 'total_contact'));
    ...
    public function update(Request $request, $id){
        ...
        if($res_updated){
            return redirect('contacts')->with('status','Contact Success Updated');
        }else{
    ...
    public function destroy($id){
        ...
        if($del_data)
        {
            return redirect('contacts')->with('status','Contact Deleted Success');
        }else{
